...
export interface IAuthRepository {
  ...
  findUserWithRoleAndMenus(userId: number): Promise<IUserWithRoleAndMenus | null>;
  findMenuByKeyMenu(keyMenu: string): Promise<IMenuBasic | null>;
  findRoleMenuByMenuAndRole(menuId: number, roleId: number): Promise<IRoleMenuPerm | null>;
  findAccessTokenByRefreshToken(refreshToken: string): Promise<IAccessTokenBasic | null>;
}
