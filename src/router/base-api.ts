...
import { validateEditProfile, validateLogin, validatePermission, verifyToken } from '../validation/auth-validation';
...
baseRouter.get('/permission', verifyToken, validatePermission, AuthController.permission);
