...
const baseUrl = '/api/app-management/user/get-details';

describe('Get User Details (External Service)', () => {
  ...
  it('should return details for valid ids when authenticated', async () => {
    ...
    // registered_at exists and is a valid ISO string
    expect(typeof first.registered_at).toBe('string');
    expect(typeof second.registered_at).toBe('string');
  });
